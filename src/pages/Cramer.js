    ...
    render(){
        return(
            <div className='allincompro'>
                <h2>Cramer's Rule</h2>
                <div>
                    <Button className='button_laout' type="primary"  onClick={this.AddMatrix}>+</Button>
                    <Button className='button_laout' type="primary" danger onClick={this.DelMatrix}>-</Button>
                    <Button className='button_laout' type="primary" onClick={this.Calculate}>Submit</Button>
